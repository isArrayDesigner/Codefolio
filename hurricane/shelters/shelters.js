...
$.ajax({
  ...
  success: function (data) {
    ...
    let shelterItems = $.each(shelterResults, function (ind, shelterItems) {
      return shelterItems
    })
            ...
            $('#shelterTableBody')
              .append(
                $('<tr class="align-middle">')
                  ...
                  .append($('<td class="py-2">' + shelterItems.Title + '</td>'))
                  .append(
                    $(
                  ...
                  .append(
                    $('<td class="py-2">' + shelterItems.Address + '</td>')
                  )
                  .append(
                    $('<td class="text-center py-2">' + petFriendly + '</td>')
                  )
              )
              .append(
                $(
